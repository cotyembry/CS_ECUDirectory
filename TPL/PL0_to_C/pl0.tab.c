...
static const yytype_uint8 yyprhs[] =
{
      ...
      30,    34,    38,    42,    44,    45,    53,    59,    60,    63,
      65,    67,    71,    74,    77,    80,    84,    89,    94,    96,
      98,   102,   104,   107,   111,   113,   115,   117,   119,   121,
     123,   125,   129,   133,   135,   139,   143,   145,   147
};
...
static const yytype_int8 yyrhs[] =
{
      ...
      41,    -1,    11,    -1,    -1,    45,    11,     5,    37,     5,
      43,    42,    -1,    45,    11,     5,    37,    46,    -1,    -1,
      44,    47,    -1,    31,    -1,    31,    -1,    11,    18,    53,
      -1,    32,    11,    -1,     7,    11,    -1,     8,    53,    -1,
      48,    50,    49,    -1,    25,    51,    26,    47,    -1,    27,
      51,    28,    47,    -1,    23,    -1,    24,    -1,    47,     5,
      50,    -1,    47,    -1,    33,    53,    -1,    53,    52,    53,
      -1,    12,    -1,    13,    -1,    14,    -1,    15,    -1,    16,
      -1,    17,    -1,    54,    -1,    53,    19,    54,    -1,    53,
      20,    54,    -1,    55,    -1,    54,    21,    55,    -1,    54,
      22,    55,    -1,    11,    -1,     3,    -1,     9,    53,    10,
      -1
};
...
{
       0,   113,   113,   116,   144,   149,   153,   157,   162,   175,
     187,   196,   219,   229,   237,   237,   253,   265,   265,   274,
     280,   285,   297,   302,   311,   328,   366,   374,   383,   399,
     404,   416,   421,   451,   459,   462,   467,   470,   473,   476,
     480,   483,   491,   500,   503,   510,   518,   521,   524
};
#endif
...
static const char *const yytname[] =
{
  ...
  "$@1", "$@2", "beginProcedure", "endProcedure", "statement",
  "startBegin", "endBegin", "statementList", "condition", "logicOP",
...
{
      17,     0,     0,    19,     0,     2,     0,    17,    17,     7,
       0,     0,     0,     0,    13,     0,     1,     3,    17,     5,
       6,     0,     0,     0,    28,     0,     0,     0,    18,     0,
       0,     0,     0,     8,     0,    11,     4,    23,    47,     0,
      46,    24,    40,    43,     0,     0,     0,     0,     0,    22,
      31,     0,    17,    10,     0,    12,     0,     0,     0,     0,
       0,    21,    32,     0,    34,    35,    36,    37,    38,    39,
       0,     0,     0,    29,    25,     0,     0,    48,    41,    42,
      44,    45,    26,    33,    27,    30,    14,    20,    16,     9,
      17,    15
};
...
{
      -1,     4,     5,     6,     7,    13,     8,    15,     9,    90,
      10,    11,    88,    50,    29,    74,    51,    46,    70,    47,
      42,    43
};
...
{
     -22,     8,    16,   -23,    29,   -23,    26,   -17,     5,   -23,
      10,    30,    28,    34,    50,    53,   -23,   -23,     5,   -23,
     -23,    48,    19,    42,   -23,     1,     1,    54,   -23,    10,
      59,    63,    56,   -23,    16,   -23,   -23,   -23,   -23,    19,
     -23,     4,    22,   -23,    19,    19,    43,    33,    40,   -23,
      65,    47,   -22,   -23,    60,   -23,    -4,    19,    19,    19,
      19,     4,     4,    10,   -23,   -23,   -23,   -23,   -23,   -23,
      19,    10,    10,   -23,   -23,     0,    70,   -23,    22,    22,
...
{
     -23,   -23,   -23,    23,   -23,   -23,    67,    44,    -7,   -23,
     -23,   -23,   -23,    -8,   -23,   -23,     7,    51,   -23,   -19,
      -1,     2
};
...
{
      19,    20,    28,    41,    38,    86,    77,     1,     2,     3,
      39,    36,    40,     2,     3,    57,    58,    21,    22,    12,
      56,    23,    38,    57,    58,    61,    62,    14,    39,    16,
      40,    87,    17,    24,    45,    25,     3,    26,    32,    33,
      31,    30,    27,    59,    60,    64,    65,    66,    67,    68,
      69,    83,    57,    58,    34,    82,    78,    79,    35,    37,
      44,    80,    81,    84,    52,    49,    53,    54,    71,    63,
      72,    73,    76,    89,    18,    75,     0,    48,    55,    85,
       0,     0,     0,    91
};

static const yytype_int8 yycheck[] =
{
       7,     8,    10,    22,     3,     5,    10,    29,    30,    31,
       9,    18,    11,    30,    31,    19,    20,     7,     8,    11,
      39,    11,     3,    19,    20,    44,    45,    11,     9,     0,
      11,    31,     6,    23,    33,    25,    31,    27,     4,     5,
      12,    11,    32,    21,    22,    12,    13,    14,    15,    16,
      17,    70,    19,    20,     4,    63,    57,    58,     5,    11,
      18,    59,    60,    71,     5,    11,     3,    11,    28,    26,
       5,    24,    12,     3,     7,    52,    -1,    26,    34,    72,
      -1,    -1,    -1,    90
};
...
{
       0,    29,    30,    31,    35,    36,    37,    38,    40,    42,
      44,    45,    11,    39,    11,    41,     0,     6,    40,    42,
      42,     7,     8,    11,    23,    25,    27,    32,    47,    48,
      11,    12,     4,     5,     4,     5,    42,    11,     3,     9,
      11,    53,    54,    55,    18,    33,    51,    53,    51,    11,
      47,    50,     5,     3,    11,    41,    53,    19,    20,    21,
      22,    53,    53,    26,    12,    13,    14,    15,    16,    17,
      52,    28,     5,    24,    49,    37,    12,    10,    54,    54,
      55,    55,    47,    53,    47,    50,     5,    31,    46,     3,
      43,    42
};
...
#line 237 "pl0.y"
    {
					...
					//Language statement
					strcpy((yyvsp[(1) - (7)].sval), "void ");
               strcat((yyvsp[(1) - (7)].sval), (yyvsp[(2) - (7)].sval));
               strcat((yyvsp[(1) - (7)].sval), "() {\n    ");
        			//$4 is the block which is (almost) anything inside the 'procedure' or 'function'
               strcat((yyvsp[(1) - (7)].sval), (yyvsp[(4) - (7)].sval));
               strcat((yyvsp[(1) - (7)].sval), "\n}\n\n");
					
					strcat((yyvsp[(1) - (7)].sval), (yyvsp[(7) - (7)].sval));

               (yyval.sval) = strdup((yyvsp[(1) - (7)].sval));
